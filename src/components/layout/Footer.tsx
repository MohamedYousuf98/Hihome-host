...
const Footer = (): JSX.Element => {
  ...
  return (
    <footer className={`pt-8 pb-8 ${isHomePage ? 'bg-gray-100' : 'bg-white'} border-t border-gray-300 px-5 sm:px-5 md:px-5 xl:px-32 2xl:px-62 py-4`}>
        <div className="flex flex-col sm:flex-row items-center justify-between pb-4 border-b border-gray-300 gap-8">
          <Image src="/images/HiHome-Logo.webp" alt="Logo" width={210} height={50} className="object-contain" />
          
          <div className="flex items-center gap-4">
            <a href="#"
                className="p-2 rounded-full border-1 border-gray-300 text-gray-700 group transition-all duration-500 hover:bg-gray-300 hover:text-white focus-within:outline-0 focus-within:bg-gray-300 focus-within:text-gray-700">
        ...
        <div className="py-8 flex flex-col lg:flex-row justify-between gap-8 border-b border-gray-300">
          <div className="w-full max-lg:mx-auto grid grid-cols-2 sm:grid-cols-3 lg:flex gap-6 md:gap-12 lg:gap-24">
            {/* Pages Section */}
            <div className="col-span-1 flex flex-col">
              <h6 className="text-lg font-medium text-gray-700 mb-7">Pages</h6>
              <ul className="flex flex-col gap-6">
                <li><Link href="#" className="text-base font-normal text-gray-700 transition-all duration-300 hover:text-black">Home</Link></li>
                <li><Link href="#" className="text-base font-normal text-gray-700 transition-all duration-300 hover:text-black">About Us</Link></li>
                <li><Link href="#" className="text-base font-normal text-gray-700 transition-all duration-300 hover:text-black">Services</Link></li>
                <li><Link href="#" className="text-base font-normal text-gray-700 transition-all duration-300 hover:text-black">Blog</Link></li>
                <li><Link href="#" className="text-base font-normal text-gray-700 transition-all duration-300 hover:text-black">Contact Us</Link></li>
              </ul>
            </div>

            {/* Quick Links Section */}
            <div className="col-span-1 flex flex-col">
              <h6 className="text-lg font-medium text-gray-700 mb-7">Quick Links</h6>
              <ul className="flex flex-col gap-6">
                <li><Link href="#" className="text-base font-normal text-gray-700 transition-all duration-300 hover:text-black">Terms & Conditions</Link></li>
                <li><Link href="#" className="text-base font-normal text-gray-700 transition-all duration-300 hover:text-black">Privacy Policy</Link></li>
                <li><Link href="#" className="text-base font-normal text-gray-700 transition-all duration-300 hover:text-black">FAQ</Link></li>
                <li><Link href="#" className="text-base font-normal text-gray-700 transition-all duration-300 hover:text-black">Support</Link></li>
              </ul>
            </div>

            {/* Help Section */}
            <div className="col-span-2 sm:col-span-1 flex flex-col items-left">
              <h6 className="text-lg font-medium text-gray-700 mb-7">Help</h6>
              <ul className="flex flex-col gap-6 text-left">
                <li><Link href="#" className="text-base font-normal text-gray-700 transition-all duration-300 hover:text-black">Get Help</Link></li>
                <li><Link href="#" className="text-base font-normal text-gray-700 transition-all duration-300 hover:text-black">Report Issue</Link></li>
                <li><Link href="#" className="text-base font-normal text-gray-700 transition-all duration-300 hover:text-black">Documentation</Link></li>
              </ul>
            </div>
          </div>

          <div className="w-full lg:max-w-md max-lg:mx-auto">
            <h6 className="text-lg font-medium text-gray-700 mb-7">Newsletter</h6>
            <div className={`${isHomePage ? 'bg-gray-100' : 'bg-white'} border-1 border-gray-300 rounded-3xl p-5`}>
              <form action="#" className="flex flex-col gap-5">
                <div className="relative">
                  <label className="flex items-center mb-2 text-gray-700 text-base font-medium">Email</label>
                  <input 
                    type="text" 
                    id="default-search"
                    className="block w-full px-5 py-3 text-md font-normal shadow-2xs text-gray-700 bg-transparent border border-gray-300 rounded-full placeholder-gray-700 focus:outline-hidden leading-relaxed focus-within:border-gray-300"
                    placeholder="Hihome@info.com" 
                    required 
                  />
                </div>
                <div className="flex flex-col min-[540px]:flex-row items-center justify-between gap-3">
                  <div className="flex items-start">
                    <input 
                      ...
                      type="checkbox" 
                      defaultChecked={true}
                      className="w-5 h-5 aspect-square appearance-none cursor-pointer border border-gray-300 bg-white rounded-md mr-2 
                      hover:border-gray-400 hover:bg-gray-100 
                       checked:border-gray-500
                      transition-all duration-300"
                    />
                    <label htmlFor="checked-checkbox" className="text-sm font-normal cursor-pointer text-gray-500">
                      I agree with <Link href="#" className="text-gray-700">Privacy Policy</Link> and <Link href="#" className="text-gray-700">Terms of Condition</Link>
                    </label>
                  </div>
                  <button 
                    type="submit"
                    className="text-gray-600 text-base font-semibold py-3 px-7 rounded-full cursor-pointer border-1 border-gray-300 transition-all duration-500 hover:bg-gray-300 hover:text-black"
                  >
                    Send
                  </button>
                </div>
        ...
        <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-5 pt-7">
          <span className="text-md font-normal text-gray-700">
            <Link href="https://pagedone.io/">
              License: Travel and Tourism Services License <br />
              License Number: 73105133
            </Link>
          </span>
          <div className="relative text-gray-700 focus-within:text-gray-900">
            ...
            <button type="button" id="default-search"
                className="block w-full lg:min-w-[448px] pr-12 pl-6 py-3 text-base text-semibold shadow-2xs text-gray-700 bg-transparent border border-gray-300 rounded-full placeholder-gray-500 focus:outline-hidden leading-relaxed transition-all duration-500 cursor-pointer ">Have
